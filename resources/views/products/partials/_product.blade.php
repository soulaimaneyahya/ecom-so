<tr>
    <td>
        <img src="{{ asset('assets/img/1.png') }}" style="width: 70px; height: 70px; object-fit: cover;" class="img-fluid" alt="{{ $product->name }}">
    </td>
    <td>
        {{ $product->name }}
    ...
    <td align="right">
        <button class="btn btn-sm btn-dark" title="view">
